...
% [-0.33627979,  0.6551842 ,  0.08813005],
% [ 0.6551842 , -0.33277217,  0.06479545],
% [ 0.08813005,  0.06479545, -0.01734464]
...
% [-3.28915910e-01,  6.61083348e-01,  4.82740073e-03],
% [ 6.61083348e-01, -3.28917372e-01,  4.97658834e-03],
% [ 4.82740073e-03,  4.97658834e-03, -7.19683122e-05]
...
% [-0.1836319 ,  0.31167794,  0.22522189],
% [ 0.31167794, -0.40649312,  0.59618603],
% [ 0.22522189,  0.59618603, -0.36727634]
...
We now turn our attention towards the pharmaceutical simulation study
...
I.e. the section labeled $T^D_i$ consists of all the delays after each process and so on for the remaining section labels. Notice that variables such as $T_8$ has been left out. This is because $T^P_8$ was constant. Hence, $T_8$ is equal to a constant added to $T^D_8$, and we therefore only use one of the variables. Here we have chosen $T^D_8$ as it has an exact interpretation.
...
M4.3 er alene, hvilket vi også kan se fra den originale figur

\begin{figure}
    \centering
    \includegraphics[width = .75\linewidth]{figures/Cycle data/G_dir times and levelchanges as graph - directed - 0_09.pdf}
\end{figure}
% As an example of why we do not place a topological assumption on durations and levels of the same process, consider a process where a reaction takes places. Clearly the amount of produced substance and duration are related, but if the process is only stopped when a certain concentration is obtained it is neither the duration nor the mass alone that ends the process. 


\textcolor{red}{ved at sammenligned med figur for e.g. M8 kan ma nse der ikke erså meget at sige på baggrund af denne. Ser også i grapf at den en alene}
